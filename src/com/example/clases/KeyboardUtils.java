 ...
 * /2150078/how-to-check-visibility-of-software-keyboard-in-android
 */
@SuppressLint("NewApi")
public class KeyboardUtils implements ViewTreeObserver.OnGlobalLayoutListener {
	...
	public static void addKeyboardToggleListener(Activity act,
	...
	public static void removeKeyboardToggleListener(
			SoftKeyboardToggleListener listener) {
	...
	private KeyboardUtils(Activity act, SoftKeyboardToggleListener listener) {
		...
		mRootView = ((ViewGroup) act.findViewById(android.R.id.content))
				.getChildAt(0);
